...
{
    #[Route('/', name: 'app_logisticincome_index', methods: ['GET'])]
    public function index(LogisticincomeRepository $logisticincomeRepository): Response
    {
        return $this->render('logisticincome/index.html.twig', [
            'logisticincomes' => $logisticincomeRepository->findAll(),
        ]);
    }
